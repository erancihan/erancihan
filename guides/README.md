...
| [four-input-fp-adder](four-input-fp-adder/) | A 14-chapter guide to floating point arithmetic in RTL, ending in a working **pipelined four-input IEEE 754 binary32 adder** in Verilog — from logic gates and number systems through the align/add/normalize/round algorithm to a specified, pipelined design with a 105-bin coverage model. 123 self-checking build targets, all green; every listing compiled and every testbench mutation-tested before it shipped |
